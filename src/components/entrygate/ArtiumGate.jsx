...
/* Solid gold silhouettes for 02/03/04 — filled shapes (fill=currentColor),
   ...
   drawn in the literal page cream (#E9E9E7, i.e. --bg) on top of the gold
  ...
  return (
    ...
    >
      <svg className="cardsvg" viewBox="0 0 260 412" aria-hidden="true">
        <defs>
          {/* Card surface now matches the page ground (--bg #E9E9E7)
          ...
          <linearGradient id={gp} gradientUnits="userSpaceOnUse" x1="0" y1="0" x2="0" y2="412">
            <stop offset="0" stopColor="#E9E9E7" /><stop offset="1" stopColor="#E9E9E7" />
          </linearGradient>
...
export default function ArtiumGate({
  ...
  React.useEffect(() => {
    ...
    document.documentElement.style.backgroundColor = "#E9E9E7";
    return () => {
