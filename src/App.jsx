      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        ...
        <div style={{ maxWidth: 560, margin: "0 auto", display: "flex", flexDirection: "column", gap: 24 }}>
          {[
            ...
            <div key={s.n} style={{ position: "relative", display: "flex", alignItems: "center", gap: 16, padding: "20px 24px", background: "#fff", borderRadius: 20, boxShadow: "0 4px 20px rgba(0,0,0,0.08)" }}>
              <div style={{ position: "absolute", top: -16, left: 22, width: 32, height: 32, borderRadius: "50%", background: "#2C3E50", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15, fontWeight: 700, fontFamily: FONT_BODY, border: "2px solid #fff", boxShadow: "0 2px 6px rgba(0,0,0,0.18)" }}>{s.n}</div>
              <div style={{ flex: 1 }}>
